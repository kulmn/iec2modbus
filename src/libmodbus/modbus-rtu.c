...
#elif MOXA_UC8410_RS485
        modbus_rtu_t *ctx_rtu = ctx->backend_data;

        // Set
            if (ioctl(ctx->s, MOXA_SET_OP_MODE, &mode) < 0) {
                return -1;
            }
...
#if MOXA_UC8410_RS485
    /* The RS485 mode has been set by default */
    ctx_rtu->serial_mode = RS485_2WIRE_MODE;
#endif
